...
local nqa = torch.class('dqn.NeuralQAgent')


function nqa:__init(args)
...
function nqa:preprocess(rawstate)
...
function nqa:sample_validation_data()
...
function nqa:compute_validation_statistics()
...
-- state is the preprocessed state
function nqa:perceive(reward, state, terminal, testing_ep)
    local curState
    ...
    --self.target_network is never used
...
function nqa:eGreedy(state, testing_ep)

...
\title{Bootstrap Aggregation of Deep Q-Networks}
...
to approximate $Q^*$ using a linear approximator, but in this case we use a 
nonlinear convolutional neural network such that, given $\theta$ weights, 
$Q(s,a;\theta) \approx Q^*(s,a)$. Spatial convolutional neural networks have 
recently increased that accuracy image recognition tasks drastically so they
are a natural function approximator.\\

...
\title{Bootstrap Aggregation of Q-Networks}
...
\begin{abstract}
I know this is dumb but I'm tired right now Lorem Ipsum 
Lorem Ipsum Lorem Ipsum Lorem Ipsum Lorem Ipsum 
\end{abstract}

\section{Q-Networks}
Abstract: quick dqn reference. 
why an ensemble of networks is a good approach (each network, even 
with the same architecture, explores random paths through games and 
therefore have different experiences. intuitively, a democratic vote 
across those experiences should yield superior results to a single dqn). 
touch on our methods for getting results (aws cluster etc). briefly 
address other approaches we took.
We should simply push all of the NIPS formatting down so we can reference it. 
It'll be very useful while editing the latex.
...
[2] Krizhevsky, Alex. "One weird trick for parallelizing convolutional neural networks." {it arXiv preprint arXiv}:1404.5997 (2014).

[3] Dean, Jeffrey, et al. "Large scale distributed deep networks." {it Advances in Neural Information Processing Systems}. 2012.

[4] Collobert, Ronan, Koray Kavukcuoglu, and Clément Farabet. "Torch7: A matlab-like environment for machine learning." {it BigLearn, NIPS Workshop}. No. EPFL-CONF-192376. 2011.
}
